...
class TestInstaller(NgrokTestCase):
    ...
    def test_installer_v2(self):
        # GIVEN
        self.given_file_doesnt_exist(self.pyngrok_config_ngrok_v2.ngrok_path)
        self.assertFalse(os.path.exists(self.pyngrok_config_ngrok_v2.ngrok_path))

        # WHEN
        ngrok.connect(pyngrok_config=self.pyngrok_config_ngrok_v2)
        ...
        # THEN
        self.assertTrue(os.path.exists(self.pyngrok_config_ngrok_v2.ngrok_path))

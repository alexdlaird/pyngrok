...
additional properties that are `supported by ngrok <https://ngrok.com/docs/agent/config/v2/#tunnel-configurations>`_,
...
a subdomain, or other tunnel properties `supported by ngrok <https://ngrok.com/docs/agent/config/v2/#tunnel-configurations>`_.

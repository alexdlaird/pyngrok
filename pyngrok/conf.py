...
class PyngrokConfig:
    ...
    :var auth_token: An ``ngrok`` authtoken to pass to commands (overrides what is in the config).
    ...
    :var edge_endpoint: The Endpoint that is mapped to the used Cloud Edge.
    :vartype edge_endpoint: str
    """
